...
<div class="col-1">
  ...
  <img src="data:image/png;base64,${iteam.imgUtility}"  width="300px"  />
	...
	<form action="updateprice?seller=${iteam.seller}&itemname=${iteam.itemname}&id=${iteam.id}" method="post">
	<input type="number" step="0.01" min="0" name="price" placeholder="update price"></input>
	<button type="submit" >enter new price</button>
	</form>
