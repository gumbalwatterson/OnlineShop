...
<c:forEach items="${iteams}" var="iteam" >
...
<!-- 
<div class="col-1">
	<img src="data:image/jpeg;base64,${tempCust.imgUtility}"  width="300px"  />
	<h4> product name</h4>
	<p>$20.00</p>
	</div>
...
<div class="col-1">
	<img src=<spring:url value="/img/product3.png"/>  width="300px"/>
	<h4> product name</h4>
	<p>$20.00</p>
	</div>
	
<div class="col-1">
	<img src=<spring:url value="/img/product4.png"/> width="300px"  />
	<h4> product name</h4>
	<p>$20.00</p>
	</div>
	
<div class="col-1">
	<img src=<spring:url value="/img/product5.png"/> width="300px" />
	<h4> product name</h4>
	<p>$20.00</p>
	</div>

<div class="col-1">
	<img src=<spring:url value="/img/product6.png"/> width="300px"  />
	<h4> product name</h4>
	<p>$20.00</p>
	</div>	
 -->
